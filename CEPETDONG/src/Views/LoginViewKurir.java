 ...
 * @author goody
 */
public class LoginViewKurir extends javax.swing.JFrame {

    /**
     * Creates new form LoginViewKurir
     */
    public LoginViewKurir() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("LOGIN COURIER PAGE");
        jPanel1.add(jLabel2);
        ...
        btn_to_reg.setBounds(310, 410, 80, 40);
        ...
        Background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pictures/Login View Kurir.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginViewKurir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginViewKurir().setVisible(true);
            }
        });
    }
