 ...
 * @author goody
 */
public class LoginViewPengirim extends javax.swing.JFrame {

    /**
     * Creates new form LoginViewPengirim
     */
    public LoginViewPengirim() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("LOGIN SENDER PAGE");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(70, 40, 270, 32);
        ...
        jPanel1.add(jLabel5);
        jLabel5.setBounds(190, 430, 110, 16);
        ...
        btn_to_reg.setBounds(301, 420, 90, 40);
        ...
        Background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pictures/Login View Pengirim.png"))); // NOI18N
        jPanel1.add(Background);
        Background.setBounds(0, 0, 414, 470);
    ...
    private void btn_to_regActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_to_regActionPerformed
        // TODO add your handling code here:
        dispose();
        RegisterViewPengirim regView = new RegisterViewPengirim();
        regView.show();
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        ...
        try {
            ...
            ctrl.loginUserPengirim(nama, ID);
            dispose();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginViewPengirim.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginViewPengirim().setVisible(true);
            }
        });
    }
